...
# oneestimation <- list()
# for ( k in 1:50){
#   onesample <- scenario_1_t[[k]]
#   tmle_estimation <- scenario_1_tmle[[k]]
#   eic_estimation <-  scenario_1_EIC[[k]]
#   oneestimation <- get_kernal_estimation(onesample,tmle.estimation=tmle_estimation,tmle.EIC=eic_estimation)
# }
